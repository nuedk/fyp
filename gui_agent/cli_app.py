...
from gui_agent.actions.grounding import OSWorldACI
from gui_agent.orchestration.agent import Agent
from gui_agent.utils.local_env import LocalEnv
...
def main():
    parser = argparse.ArgumentParser(description="Run Agent with specified model.")
    parser.add_argument(
        "--provider",
        type=str,
        default="openai",
